      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Explore projetos incríveis criados pela nossa comunidade de desenvolvedores
          </p>
        </div>
                ...
                <div className="aspect-video relative overflow-hidden bg-muted">
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-3">
                    <Button
                      size="sm"
                      variant="secondary"
                      onClick={() => handleViewProject(project.share_token)}
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (project.share_token) {
                          window.open(`${window.location.origin}/shared/${project.share_token}`, "_blank");
                        }
                      }}
                      disabled={!project.share_token}
                    >
