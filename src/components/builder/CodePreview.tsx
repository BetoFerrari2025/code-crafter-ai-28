...
const CodePreview = ({ generatedCode, isGenerating, onCodeChange }: CodePreviewProps) => {
  ...
  const { addVersion, undo, redo, canUndo, canRedo } = useCodeHistory();
            ...
            {displayCode ? (
              ...
              <div className="h-full flex items-center justify-center p-8">
                <div className="text-center space-y-4 animate-fade-in">
                  <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-primary to-blue-500 flex items-center justify-center shadow-lg">
