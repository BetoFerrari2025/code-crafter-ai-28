...
const translations: Record<string, Record<Language, string>> = {
  ...
  // Editor
  "editor.accessDenied": { pt: "Acesso negado", en: "Access denied" },
  "editor.loginRequired": { pt: "Você precisa fazer login para acessar o chat.", en: "You need to sign in to access the chat." },
  "editor.projectLoaded": { pt: "carregado", en: "loaded" },
  "editor.continueEditing": { pt: "Continue editando seu projeto.", en: "Continue editing your project." },
  "editor.checkingAuth": { pt: "Verificando autenticação...", en: "Checking authentication..." },

  // CodePreview
  "preview.preview": { pt: "Preview", en: "Preview" },
  "preview.code": { pt: "Código", en: "Code" },
  "preview.undo": { pt: "Desfazer", en: "Undo" },
  "preview.redo": { pt: "Refazer", en: "Redo" },
  "preview.undoDesc": { pt: "Versão anterior restaurada", en: "Previous version restored" },
  "preview.redoDesc": { pt: "Versão seguinte restaurada", en: "Next version restored" },
  "preview.copyCode": { pt: "Copiar código", en: "Copy code" },
  "preview.copied": { pt: "Copiado!", en: "Copied!" },
  "preview.copiedDesc": { pt: "Código copiado para a área de transferência", en: "Code copied to clipboard" },
  "preview.copyError": { pt: "Não foi possível copiar", en: "Could not copy" },
  "preview.reload": { pt: "Recarregar preview", en: "Reload preview" },
  "preview.reloadDesc": { pt: "Nova tentativa de renderização executada.", en: "New render attempt executed." },
  "preview.download": { pt: "Baixar código", en: "Download code" },
  "preview.downloadDesc": { pt: "Código baixado com sucesso!", en: "Code downloaded successfully!" },
  "preview.publish": { pt: "Publicar", en: "Publish" },
  "preview.versionHistory": { pt: "Histórico de versões", en: "Version history" },
  "preview.restore": { pt: "Restaurar", en: "Restore" },
  "preview.restoreDesc": { pt: "Última versão funcional restaurada com sucesso.", en: "Last working version restored successfully." },
  "preview.tryFix": { pt: "Tentar corrigir", en: "Try to fix" },
  "preview.edit": { pt: "Editar", en: "Edit" },
  "preview.save": { pt: "Salvar", en: "Save" },
  "preview.saved": { pt: "Salvo!", en: "Saved!" },
  "preview.savedDesc": { pt: "Alterações aplicadas ao preview", en: "Changes applied to preview" },
  "preview.generating": { pt: "Gerando código...", en: "Generating code..." },
  "preview.compiling": { pt: "Compilando...", en: "Compiling..." },
  "preview.livePreview": { pt: "Preview ao vivo", en: "Live preview" },
  "preview.previewError": { pt: "Erro no preview", en: "Preview error" },
  "preview.interactiveView": { pt: "Visualização interativa", en: "Interactive preview" },
  "preview.aiCode": { pt: "Código gerado pela IA", en: "AI generated code" },
  "preview.emptyPreview": { pt: "O preview foi carregado em branco.", en: "The preview loaded blank." },
  "preview.loadFailed": { pt: "Falha ao gerar o preview.", en: "Failed to generate preview." },
  "preview.loadedBlank": { pt: "Preview carregou em branco.", en: "Preview loaded blank." },
  "preview.loadError": { pt: "Falha ao carregar o preview.", en: "Failed to load the preview." },
  "preview.yourApp": { pt: "Seu App Aqui", en: "Your App Here" },
  "preview.yourAppDesc": { pt: "O código gerado pela IA aparecerá aqui em tempo real. Descreva o que você quer criar no chat e veja o resultado instantaneamente.", en: "The AI generated code will appear here in real time. Describe what you want to create in the chat and see the result instantly." },
  "preview.projectSaved": { pt: "✅ Projeto salvo e compartilhado!", en: "✅ Project saved and shared!" },
  "preview.projectSavedDesc": { pt: "Link copiado e aberto em nova aba.", en: "Link copied and opened in new tab." },
  "preview.saveError": { pt: "Erro ao salvar", en: "Error saving" },
  "preview.saveErrorDesc": { pt: "Não foi possível salvar o projeto. Tente novamente.", en: "Could not save the project. Try again." },
  "preview.loginNeeded": { pt: "Login necessário", en: "Login required" },
  "preview.loginRedirect": { pt: "Redirecionando para a página de login...", en: "Redirecting to login page..." },
  "preview.versionRestored": { pt: "Restaurado", en: "Restored" },
  "preview.versionRestoredDesc": { pt: "Versão restaurada", en: "Version restored" },
  "preview.aiGenerated": { pt: "Código gerado pela IA", en: "AI generated code" },
  "preview.manualEdit": { pt: "Editado manualmente", en: "Manually edited" },
  "preview.restoredWorking": { pt: "Restaurado (última versão funcional)", en: "Restored (last working version)" },

  // GitHub/Supabase dialogs
  "connect.github": { pt: "Conectar GitHub", en: "Connect GitHub" },
  "connect.githubDesc": { pt: "Vincule um repositório GitHub ao seu projeto.", en: "Link a GitHub repository to your project." },
  "connect.githubConnected": { pt: "GitHub conectado", en: "GitHub connected" },
  "connect.githubDisconnected": { pt: "GitHub desconectado", en: "GitHub disconnected" },
  "connect.repo": { pt: "Repositório (owner/repo)", en: "Repository (owner/repo)" },
  "connect.token": { pt: "Personal Access Token", en: "Personal Access Token" },
  "connect.fillFields": { pt: "Preencha o repositório e o token.", en: "Fill in the repository and token." },
  "connect.connected": { pt: "Conectado", en: "Connected" },
  "connect.disconnect": { pt: "Desconectar", en: "Disconnect" },
  "connect.supabase": { pt: "Conectar Supabase", en: "Connect Supabase" },
  "connect.supabaseDesc": { pt: "Vincule um projeto Supabase para banco de dados e autenticação.", en: "Link a Supabase project for database and authentication." },
  "connect.supabaseConnected": { pt: "✅ Supabase conectado!", en: "✅ Supabase connected!" },
  "connect.supabaseConnectedDesc": { pt: "Projeto vinculado com sucesso.", en: "Project linked successfully." },
  "connect.supabaseDisconnected": { pt: "Supabase desconectado", en: "Supabase disconnected" },
  "connect.projectUrl": { pt: "URL do Projeto", en: "Project URL" },
  "connect.anonKey": { pt: "Chave Anon (pública)", en: "Anon Key (public)" },
  "connect.fillUrlKey": { pt: "Preencha a URL e a chave.", en: "Fill in the URL and key." },
  "connect.githubSuccess": { pt: "✅ GitHub conectado!", en: "✅ GitHub connected!" },
  "connect.repoLinked": { pt: "Repositório vinculado.", en: "Repository linked." },
};
